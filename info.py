...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dqfilterbot:dqfilterbot@cluster0.ekfevqa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "DQ FILTER BOT")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002207001854))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', ' -1002179801894')).split()]
